...
#' Add additional igraph vertex shape
#'
...
#'
#' @export
add_shape_circle2 = function() {
if (is.null(igraph::shapes(shape = "textility::circle2"))) {
  ...
  add.vertex.shape("textility::circle2", clip = igraph.shape.noclip,
